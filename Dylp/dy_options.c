...
/*
  ...
  typedef for bool in dylib_std.h, you'll see that it can change in size ---
  this is necessary for C++ compatibility in the COIN OSI layer
  ...
  Parameters:  bloc: address where the boolean is to be placed.
